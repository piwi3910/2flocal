...
const qrCodeHandler_1 = require("../qrCodeHandler");
describe('QR Code Handler', () => {
    describe('parseTOTPUri', () => {
        ...
        it.skip('should parse a valid TOTP URI', () => {
            ...
            const result = (0, qrCodeHandler_1.parseTOTPUri)(uri);
        ...
        it('should throw an error for invalid URI format', () => {
            ...
            expect(() => (0, qrCodeHandler_1.parseTOTPUri)(uri)).toThrow('Invalid TOTP URI format');
        });
        it.skip('should throw an error for missing secret', () => {
            const uri = 'otpauth://totp/Example:alice@example.com?issuer=Example';
            expect(() => (0, qrCodeHandler_1.parseTOTPUri)(uri)).toThrow('Missing secret parameter in TOTP URI');
        });
        it.skip('should throw an error for unsupported OTP type', () => {
            ...
            expect(() => (0, qrCodeHandler_1.parseTOTPUri)(uri)).toThrow('Unsupported OTP type: hotp');
        });
    });
    describe('generateTOTPUri', () => {
        it('should generate a valid TOTP URI with all parameters', () => {
            ...
            const uri = (0, qrCodeHandler_1.generateTOTPUri)(components);
